...
Route.get("/admin/subjects/:id/assign", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.assignTeachers);
Route.get("/admin/subjects/:id/teachers-modal", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.getTeachersModal);
Route.post("/admin/subjects/:id/assign-teachers", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.assignTeacher);
Route.post("/admin/subjects/:id/batch-assign-teachers", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.batchAssignTeachers);
Route.post("/admin/subjects/:id/assign-teacher", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.assignTeacher);
Route.delete("/admin/subjects/:subject_id/unassign-teacher/:teacher_id", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.unassignTeacher);
Route.get("/admin/subjects/:id/assign-classes", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.assignClasses);
Route.post("/admin/subjects/:id/assign-class", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.assignToClass);
Route.put("/admin/subjects/assignment/:assignmentId", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.updateClassAssignment);
Route.delete("/admin/subjects/:id/unassign-class", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.unassignFromClass);
Route.get("/api/subjects/unique-classes", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.getUniqueClasses);
Route.post("/admin/subjects/:id/schedule", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.createSchedule);
Route.get("/admin/subjects/:id/schedules", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.getSchedules);
Route.delete("/admin/subjects/schedule/:scheduleId", [auth_1.default, roleAuth_1.default.admin()], SubjectController_1.default.deleteSchedule);
